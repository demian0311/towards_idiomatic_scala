object pattern_matching {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(72); 
  ...
  val foo = 1;System.out.println("""foo  : Int = """ + $show(foo ));$skip(127); val res$0 = 
  foo match {
    case 0 => "this is a zero"
    case 1 => "this is a one"
    case _      => 0 // don't want a MatchError
  };System.out.println("""res0: Any = """ + $show(res$0));$skip(21); 
  ...
  // wildcard pattern
  case class Fruit(name: String, color: String);System.out.println("""res2: java.lang.String = """ + $show(res$2));$skip(111); 
  ...
  val cherry = Fruit("cherry", "red");System.out.println("""cherry  : pattern_matching.Fruit = """ + $show(cherry ));$skip(227); val res$3 = 
